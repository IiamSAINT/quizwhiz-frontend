              ...
              <div className='hidden md:block bg-quiz-soft-purple relative overflow-hidden'>
                <div className='absolute inset-0 flex items-center justify-center p-8'>
                  <div className='text-center'>
                    ...
                    <h3 className='text-2xl font-bold text-quiz-dark mb-3'>Test Your Knowledge</h3>
                    <p className='text-quiz-primary max-w-md'>
                      Create engaging quizzes, challenge friends, and track your progress with our
                      powerful quiz platform.
                    </p>
