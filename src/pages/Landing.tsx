        ...
        <section className="relative py-40 bg-gradient-to-br from-quiz-primary to-quiz-secondary overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p
                className="text-xl text-white/90 mb-10 animate-fade-in"
              ...
              >
                <Link to="/signup">
                  <Button
                    size="lg"
                    className="bg-white text-quiz-primary hover:bg-gray-100 rounded-full px-8"
                  >
                    Get Started
                  </Button>
                </Link>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                QuizWhizz provides all the tools needed to create engaging
                quizzes and facilitate interactive learning experiences.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow text-center">
                ...
                <p className="text-gray-600">
                  Build custom quizzes with multiple question types, images, and
                  videos. Set time limits and scoring rules.
                </p>
              </div>
              <div className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow text-center">
                <div className="feature-icon mx-auto">
                ...
                <p className="text-gray-600">
                  Jump into live quiz sessions with a simple code. Compete with
                  friends and see real-time leaderboards.
                </p>
              </div>
              <div className="bg-white rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow text-center">
                <div className="feature-icon mx-auto">
                ...
                <p className="text-gray-600">
                  Review detailed analytics and performance metrics. Monitor
                  progress over time with beautiful charts.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                <div className="bg-quiz-soft-purple w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-quiz-primary mx-auto mb-4">
                  1
                </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Add questions, media, and customize settings
                </p>
              </div>
              <div className="text-center">
                <div className="bg-quiz-soft-purple w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-quiz-primary mx-auto mb-4">
                ...
                <p className="text-gray-600">
                  Start a live session and invite participants
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-8 shadow-sm relative">
                ...
                <p className="text-gray-600 mb-6">
                  "QuizWhizz has transformed how I engage with my students. The
                  real-time feedback and competitive elements keep everyone
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm relative">
                ...
                <p className="text-gray-600 mb-6">
                  "As a corporate trainer, I've tried many quiz platforms, but
                  QuizWhizz stands out with its intuitive design and powerful
                  analytics. My team loves the interactive sessions."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gray-200 mr-4"></div>
                  <div>
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm relative">
                ...
                <p className="text-gray-600 mb-6">
                  "I use QuizWhizz for our weekly team building activities. It's
                  so simple to create custom quizzes and the multiplayer aspect
                  makes it incredibly fun for everyone."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gray-200 mr-4"></div>
                  <div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 text-white/90">
                Join thousands of educators and trainers who use QuizWhizz to
                engage and motivate their audience.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link to="/signup">
                  <Button
                    size="lg"
                    className="bg-white text-quiz-primary hover:bg-gray-100 rounded-full px-8 btn-hover-effect"
                  >
                    Get Started Free
                  </Button>
                </Link>
                <Button
                  size="lg"
                  variant="outline"
                  className="bg-transparent border-white text-white hover:bg-white/10 rounded-full px-8 btn-hover-effect"
                >
