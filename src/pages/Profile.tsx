...
const userData = {
  ...
  achievements: [
    ...
    },
    {
      id: 4,
      title: 'Popular Host',
      description: 'Host a quiz with 20+ participants',
      unlocked: false,
      progress: 80,
    },
    {
    ...
    },
    {
      ...
      description: 'Create quizzes in 5 different categories',
      unlocked: false,
      progress: 40,
    },
  ],
                    ...
                    <div
                      ...
                      className={`border rounded-lg p-5 ${
                        achievement.unlocked
                          ? 'bg-quiz-soft-purple border-quiz-light'
