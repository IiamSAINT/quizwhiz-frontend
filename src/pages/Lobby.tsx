          ...
          <div className='bg-white rounded-xl shadow-sm overflow-hidden'>
            ...
            <div className='bg-gradient-to-r from-quiz-primary to-quiz-secondary p-6 text-white'>
              <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4'>
                ...
                <div className='flex items-center gap-3'>
                  <Badge className='bg-white/20 hover:bg-white/30 text-white'>20 Questions</Badge>
                  <Badge className='bg-white/20 hover:bg-white/30 text-white'>60 Seconds/Q</Badge>
                </div>
              </div>
            </div>
            ...
            <div className='p-6'>
              ...
              <div className='text-center mb-8'>
                ...
                {isHost ? (
                  <Button className='bg-quiz-primary hover:bg-quiz-secondary' size='lg'>
                  ...
                  <div className='bg-gray-50 p-4 rounded-lg'>
                    ...
                    <div className='flex items-center gap-2'>
                      ...
                      <Button
                        ...
                        className={cn('px-3', copySuccess ? 'bg-green-500 hover:bg-green-600' : '')}
